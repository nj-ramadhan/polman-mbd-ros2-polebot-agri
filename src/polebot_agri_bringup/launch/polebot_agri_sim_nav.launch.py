...
def generate_launch_description():
    ...
    pkg_polebot_simulation = get_package_share_directory('polebot_agri_simulation')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(pkg_polebot_description, 'config', 'polebot_agri_nav2_params.yaml'),
    ...
    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(pkg_polebot_description, 'src', 'description', 'polebot_agri_description.sdf'),
    ...
    gz_robot = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_polebot_simulation, 'launch', 'polebot_agri_spawn.launch.py')),
