...
def generate_launch_description():
    ...
    gz_ros_bridge = Node(
        ...
        arguments=[ 
            ...
            '/model/polebot_agri/cmd_vel@geometry_msgs/msg/Twist@gz.msgs.Twist',
            '/model/polebot_agri/odometry@nav_msgs/msg/Odometry@gz.msgs.Odometry',
            '/diff_drive_controller/odom@nav_msgs/msg/Odometry[gz.msgs.Odometry',
            '/scan@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan',
            '/model/polebot_agri/joint_state@sensor_msgs/msg/JointState@gz.msgs.Model',
            '/joint_states@sensor_msgs/msg/JointState[gz.msgs.Model',
            '/model/polebot_agri/imu@sensor_msgs/msg/Imu[gz.msgs.IMU'
        ],
        remappings=[
            ('/model/polebot_agri/odometry', '/diff_drive_controller/odom'),
            ('/model/polebot_agri/cmd_vel', '/cmd_vel_unstamped'),
            ('/model/polebot_agri/joint_state', '/joint_states'),
            ('/model/polebot_agri/imu', '/imu/data')
        ],
        output='screen',
    ...
    joystick = IncludeLaunchDescription(
            PythonLaunchDescriptionSource ([os.path.join(get_package_share_directory('polebot_agri'),'launch','teleop_joy.launch.py')
                                        ]), launch_arguments={'use_sim_time': 'true'}.items()
            )

    twist_mux_params = os.path.join(get_package_share_directory('polebot_agri'),'config','twist_mux.yaml')
    twist_mux = Node(
            package="twist_mux",
    ...
    smc_controller_node = Node(
            package='polebot_agri_smc_controller',
            executable='polebot_agri_smc_controller',  # Name of the Python file or executable
            name='polebot_agri_smc_controller_node',
            output='screen',
    ...
    coordinate_publisher_node = Node(
        package='polebot_agri_coordinate_publisher',
        executable='polebot_agri_coordinate_publisher',
        name='polebot_agri_coordinate_publisher_node',
        output='screen',
        parameters=[{'use_sim_time': use_sim_time}],
    )

    trajectory_creator_node = Node(
        package='polebot_agri_trajectory_creator',
        executable='polebot_agri_trajectory_creator',
        name='polebot_agri_trajectory_creator_node',
        output='screen',
        parameters=[{'use_sim_time': use_sim_time}],
    )
    ...
    #     package='polebot_agri_hw_arduino_driver',
    #     executable='polebot_agri_hw_arduino_driver',
    ...
    #     package='polebot_agri_hw_esp_encoder',
    #     executable='polebot_agri_hw_esp_encoder',
