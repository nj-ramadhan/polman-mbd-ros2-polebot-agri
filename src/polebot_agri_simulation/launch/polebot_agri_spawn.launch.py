...
def generate_launch_description():
    sim_dir = get_package_share_directory('polebot_agri_simulation')
    desc_dir = get_package_share_directory('polebot_agri_description')
        ...
        parameters=[
            {
                'config_file': os.path.join(
                    sim_dir, 'configs', 'polebot_agri_bridge.yaml'
                ),
